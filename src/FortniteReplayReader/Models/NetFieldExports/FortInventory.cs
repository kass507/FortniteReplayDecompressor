...
public class FortInventory : INetFieldExportGroup
{
    ...
    [NetFieldExport("RemovedDataTypes", RepLayoutCmdType.PropertyUInt16)]
    public ushort? RemovedDataTypes { get; set; }
 
    [NetFieldExport("SlotNumber", RepLayoutCmdType.PropertyUInt32)]
