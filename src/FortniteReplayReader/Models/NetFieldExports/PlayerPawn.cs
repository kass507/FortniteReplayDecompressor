...
public class PlayerPawn : INetFieldExportGroup
{
    ...
    [NetFieldExport("RepMovementModeExtension", RepLayoutCmdType.Ignore)]
    public DebuggingObject RepMovementModeExtension { get; set; }
 
    [NetFieldExport("CapsuleRadiusFortPawn", RepLayoutCmdType.PropertyFloat)]
    public float? CapsuleRadiusFortPawn { get; set; }
 
    [NetFieldExport("CapsuleHalfHeightFortPawn", RepLayoutCmdType.PropertyFloat)]
    public float? CapsuleHalfHeightFortPawn { get; set; }
 
    [NetFieldExport("MeshHeightAdjustFortPawn", RepLayoutCmdType.PropertyDouble)]
    public double? MeshHeightAdjustFortPawn { get; set; }
 
    [NetFieldExport("AttributeReplicationProxy", RepLayoutCmdType.Ignore)]
    public DebuggingObject AttributeReplicationProxy { get; set; }
 
    [NetFieldExport("SimulatedProxyActiveGameplayCues", RepLayoutCmdType.Ignore)]
    public DebuggingObject SimulatedProxyActiveGameplayCues { get; set; }
 
    [NetFieldExport("SimulatedProxyMinimalReplicationGameplayCues", RepLayoutCmdType.Ignore)]
    public DebuggingObject SimulatedProxyMinimalReplicationGameplayCues { get; set; }
 
    [NetFieldExport("BaseID", RepLayoutCmdType.PropertyUInt16)]
    public ushort? BaseID { get; set; }
 
    [NetFieldExport("DataTable", RepLayoutCmdType.PropertyUInt16)]
    public ushort? DataTable { get; set; }
 
    [NetFieldExport("RowName", RepLayoutCmdType.Ignore)]
    public DebuggingObject RowName { get; set; }
 
    [NetFieldExport("bIsRandomDefaultCosmeticHashSet", RepLayoutCmdType.PropertyBool)]
    public bool? bIsRandomDefaultCosmeticHashSet { get; set; }
 
    [NetFieldExport("RandomDefaultCosmeticHashValue", RepLayoutCmdType.PropertyUInt32)]
    public uint? RandomDefaultCosmeticHashValue { get; set; }
 
    [NetFieldExport("PrimaryAssets", RepLayoutCmdType.Ignore)]
    public DebuggingObject PrimaryAssets { get; set; }
 
    [NetFieldExport("AssetIndices", RepLayoutCmdType.Ignore)]
    public DebuggingObject AssetIndices { get; set; }
 
    [NetFieldExport("GravityZScale", RepLayoutCmdType.PropertyFloat)]
    public float? GravityZScale { get; set; }
 
    [NetFieldExport("JumpZVelocity", RepLayoutCmdType.PropertyFloat)]
    public float? JumpZVelocity { get; set; }
 
    [NetFieldExport("EmoteWalkSpeed", RepLayoutCmdType.PropertyFloat)]
    ...
    [NetFieldExport("On Death Damage Tags", RepLayoutCmdType.Ignore)]
    public DebuggingObject OnDeathDamageTags { get; set; }
 
    [NetFieldExport("On Death Momentum", RepLayoutCmdType.Ignore)]
    public DebuggingObject OnDeathMomentum { get; set; }
 
    [NetFieldExport("On Death Effect Context", RepLayoutCmdType.Ignore)]
    public DebuggingObject OnDeathEffectContext { get; set; }
 
    [NetFieldExport("On Death Controller", RepLayoutCmdType.PropertyObject)]
    public uint? OnDeathController { get; set; }
 
    [NetFieldExport("Animation", RepLayoutCmdType.PropertyObject)]
    public uint? Animation { get; set; }
 
    [NetFieldExport("bIsTargetingConsumableThrow", RepLayoutCmdType.PropertyBool)]
    public bool? bIsTargetingConsumableThrow { get; set; }
 
    [NetFieldExport("bIsDisconnectedPawn", RepLayoutCmdType.PropertyBool)]
    public bool? bIsDisconnectedPawn { get; set; }
 
    [NetFieldExport("bShouldUseCharacterMovementIdleFastPath", RepLayoutCmdType.PropertyBool)]
    public bool? bShouldUseCharacterMovementIdleFastPath { get; set; }
 
    [NetFieldExport("FastReplicationReplicatedLooseTags", RepLayoutCmdType.Ignore)]
    public DebuggingObject FastReplicationReplicatedLooseTags { get; set; }
 
    [NetFieldExport("bRelativePosition", RepLayoutCmdType.PropertyBool)]
    public bool? bRelativePosition { get; set; }
 
    [NetFieldExport("BalloonActiveCount", RepLayoutCmdType.PropertyByte)]
    public byte? BalloonActiveCount { get; set; }
 
    [NetFieldExport("StasisModes", RepLayoutCmdType.Ignore)]
    public DebuggingObject StasisModes { get; set; }
}