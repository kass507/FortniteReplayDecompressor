...
public class GameState : INetFieldExportGroup
{
    ...
    public DebuggingObject TeamFlightPaths { get; set; }
    ...
    [NetFieldExport("Version", RepLayoutCmdType.PropertyUInt32)]
    public uint? Version { get; set; }
 
    [NetFieldExport("MatchmakingLinkType", RepLayoutCmdType.Ignore)]
    public DebuggingObject MatchmakingLinkType { get; set; }
 
    [NetFieldExport("ProductTag", RepLayoutCmdType.Ignore)]
    public DebuggingObject ProductTag { get; set; }
 
    [NetFieldExport("bEpicOriginal", RepLayoutCmdType.PropertyBool)]
    public bool? bEpicOriginal { get; set; }
 
    [NetFieldExport("POIManager", RepLayoutCmdType.PropertyObject)]
    public uint? POIManager { get; set; }
 
    [NetFieldExport("ReplicatedServerTickRate", RepLayoutCmdType.Ignore)]
    public DebuggingObject ReplicatedServerTickRate { get; set; }
 
    [NetFieldExport("ClientItemDefsToLoad", RepLayoutCmdType.Ignore)]
    public DebuggingObject ClientItemDefsToLoad { get; set; }
 
    [NetFieldExport("BroadcastSpectatorInfo", RepLayoutCmdType.PropertyObject)]
    public uint? BroadcastSpectatorInfo { get; set; }
 
    [NetFieldExport("AICharacterPartsPreloadData", RepLayoutCmdType.Ignore)]
    public DebuggingObject AICharacterPartsPreloadData { get; set; }
 
    [NetFieldExport("bIsTournamentMatch", RepLayoutCmdType.PropertyBool)]
    public bool? bIsTournamentMatch { get; set; }
 
    [NetFieldExport("RolledLootGroupTags", RepLayoutCmdType.Ignore)]
    public DebuggingObject RolledLootGroupTags { get; set; }
